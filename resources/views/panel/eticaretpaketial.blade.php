...
<head>
    <title>E-very Sitenizi Oluşturun</title>
    <meta charset="UTF-8" />
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('plesk/vendor/bootstrap/css/bootstrap.min.css') }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('plesk/fonts/font-awesome-4.7.0/css/font-awesome.min.css') }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('plesk/fonts/iconic/css/material-design-iconic-font.min.css') }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('plesk/vendor/animate/animate.css') }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('plesk/vendor/css-hamburgers/hamburgers.min.css') }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('plesk/vendor/animsition/css/animsition.min.css') }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('plesk/vendor/select2/select2.min.css') }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ 'plesk/vendor/daterangepicker/daterangepicker.css' }}" />
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('plesk/css/util.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('plesk/css/main.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminassets/css/intlTelInput.css') }}">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/google-closure-library/20230411.0.0/base.min.js"></script>
    <script src="{{ asset('plesk/js/sweetalert.js') }}"></script>
    <script src="{{ asset('adminassets/js/utils.js') }}"></script>
    <script src="{{ asset('adminassets/js/intlTelInput.min.js') }}"></script>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-image: url("../assets/plesk/images/arkaplan.jpg");
...
<body style="background:url('{{ asset('plesk/images/arkaplan.jpg') }}')">
    <div class="limiter py-5" id="loginPage">
        <div class="container-login100">
            <div class="wrap-login100">
                <form id="form" class="login100-form validate-form">
                    @csrf
                    <span class="login100-form-logo">
                        <a href="https://e-very.com.tr/">
                            <img src="{{ asset('plesk/images/logo.png') }}" id="every-logo" alt="">
                        </a>
                    </span>

                    <span class="login100-form-title pb-1 p-t-27"> E-ticaret Sitenizi Açın</span>
                    <span class="login100-form-desc p-b-34">Girişimciler için E-Very Süre Sınırsız Ücretsiz</span>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wrap-input100 validate-input" data-validate="Şifrenizi girin">
                                <input class="input100 text-center w-100" disabled type="text"
                                    value="Ürün adı : {{ strtoupper($parametre) }} paketi" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Adınızı girin">
                                <input class="input100" type="text" required name="name" placeholder="Ad" />
                                <span class="focus-input100" data-placeholder="&#xf207;"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="wrap-input100 validate-input" data-validate="Soyadınızı girin">
                                <input class="input100" type="text" required name="surname" placeholder="Soyad" />
                                <span class="focus-input100" data-placeholder="&#xf207;"></span>
                            </div>
                        </div>
                    </div>
                    <div class="wrap-input100 input-group">
                        <input class="input100" type="text" id="magaza" name="magaza"
                            data-validate="Magaza adını girin" placeholder="Mağaza Adınız" />
                        <span class="focus-input100" data-placeholder="&#xf110;"></span>
                        <span class="input-group-text" id="basic-addon2">.e-very.com.tr</span>
                    </div>
                    <input type="hidden" name="email" value="selimlavuk@gmail.com">
                    <div class="wrap-input100 validate-input" data-validate="Şifrenizi girin">
                        <input class="input100 w-100" type="password" required name="password" placeholder="Şifre" />
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>

                    <input type="hidden" name="urun" value="{{ $parametre }}">
                    <div class="contact100-form-checkbox">
                        <input class="input-checkbox100 w-100" required id="ckb1" type="checkbox"
                            name="kvkk" />
                        <label class="label-checkbox100" for="ckb1"> Kişisel verilerin işlenmesine yönelik
                            aydınlatma
                            <br> ve <a target="_blank" href="views/porto/assets/plesk/files/e-verykvkk.pdf"><b>Açık
                                    rıza
                                    metnini</b></a> okudum, onaylıyorum.</label>
                    </div>
                    <div class="container-login100-form-btn">
                        <button type="button" id="formBtn" class="login100-form-btn">Hesabımı Oluştur</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <div id="loader" class="w-100" style="display: none;">
        ...
        <h2 class="text-center dotHiki">E-ticaret siteniz hazırlanıyor
            <div class="dot"></div>
            <div class="dot"></div>
            <div class="dot"></div>
        </h2>
        <div class="store-container">
            <div class="border-animation">
                <svg role="img" xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
                    <title xml:lang="en">E-ticaret Siteniz Hazırlıyor</title>
                    <defs>
                        <filter id="f1">
                            <feGaussianBlur in="SourceGraphic" stdDeviation="0,4" />
                        </filter>
                        <circle id="sky-circle" fill="none" class="stroke" cx="198.7" cy="314"
                            r="5.5" />
                        ...
                        <path id="cloud2" fill="#FFF" class="stroke" transform="scale(.8)"
                            d="M503.6 39.1c-2.9 0.2-5.8 0.7-8.5 1.4 -14.7-24.5-42.3-40-72.8-37.8 -31.2 2.2-56.9 22.4-67.6 49.7 -2.5-0.4-5-0.5-7.6-0.3 -18.5 1.3-32.5 17.4-31.2 35.9s17.4 32.5 35.9 31.2c2.3-0.2 4.6-0.6 6.8-1.2 14.1 26.5 42.9 43.6 74.8 41.3 23.1-1.6 43.2-13.1 56.4-30.1 6.3 2.5 13.2 3.6 20.4 3.1 25.7-1.8 45.1-24.1 43.3-49.9C551.6 56.7 529.3 37.3 503.6 39.1z" />
                        <g id="tree">
                            <rect x="1114.2" y="721.5" fill="#FFF" class="stroke" width="22"
                                height="127" />
                            <g opacity="0.4">
                                <path fill="#00704f"
                                ...
                                <path fill="#00704f" d="M1153.9 561c4-2.4 7.7-5.4 11-8.7" />
                                <path fill="#00704f" d="M1104.3 545.5c-6.7 1.6-13.1 3.9-19.1 7" />
                            </g>
                        ...
                        <g id="cat">
                            <circle fill="#00704f" cx="1115" cy="625" r="25"></circle>
                            <path fill="#FFF" stroke="#00704f" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" stroke-miterlimit="10"
                                d="M1097.1 612.3c0 0-4.5-9.3-0.3-17.7 0 0 4.5 5.6 9.3 7" />
                            <path fill="#FFF" stroke="#00704f" stroke-width="3" stroke-linecap="round"
                                stroke-linejoin="round" stroke-miterlimit="10"
                                d="M1140.6 612.3c0 0 4.5-9.3 0.3-17.7 0 0-4.5 5.6-9.3 7" />
                            <circle fill="#FFF" stroke="#00704f" stroke-width="3" stroke-linecap="round"
                        ...
                        <g id="box">
                            <rect x="356" y="47" fill="#FFF" class="stroke" width="106.2"
                                height="86" />
                            ...
                            <polygon opacity="0.4" fill="#00704f"
                        ...
                        <g id="cap">
                            ...
                            <ellipse fill="#00704f" cx="445.9" cy="763.4" rx="8.5" ry="3" />
                            <path fill="none" class="stroke"
                                d="M406.4 819.4c0-20.7-4.8-52 39.5-52.5 44.7-0.5 39.5 31.8 39.5 52.5" />
                            <line fill="none" class="stroke" x1="445.9" y1="766.4" x2="445.9"
                                y2="816.4" />
                            <circle fill="#00704f" cx="429.4" cy="777.4" r="2" />
                            <circle fill="#00704f" cx="462.4" cy="777.4" r="2" />
                        </g>
                        <g id="ball">
                            <circle fill="#FFF" class="stroke" cx="446" cy="803.8" r="47.3" />
                            <line fill="none" class="stroke" x1="446" y1="756.8" x2="446"
                                y2="850.8" />
                            <line fill="none" class="stroke" x1="493" y1="804.3" x2="399"
                                y2="804.3" />
                            <path fill="none" class="stroke"
                        ...
                        <g id="plane">
                            ...
                            <line fill="none" class="stroke" x1="728" y1="213.3" x2="520"
                                y2="213.2" />
                            ...
                            <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family="Fredoka One"
                                font-size="30" fill="#00704f">
                                E-ticaret Sitenizi Hazırlıyoruz
                            </text>
                            <path fill="#a5c7e4"
                    ...
                    <circle class="cat-shadow" fill="#00704f" cx="1160" cy="620" r="23">
                    </circle>
                    ...
                    <g id="browser">
                        ...
                        <path fill="none" stroke="#00704f" class="stroke"
                    ...
                    <g id="toldo">
                        ...
                        <line class="stroke round-end" x1="277" y1="470.5" x2="1027"
                            y2="470.5" />
                        ...
                        <line fill="none" class="stroke" x1="944.4" y1="471.6" x2="913.2"
                            y2="392.2" />
                    </g>
                    <g id="door">
                        <path fill="none" class="stroke"
                            d="M955.8 846V560.5c0-5.5-4.5-10-10-10H738.6c-5.5 0-10 4.5-10 10V846" />
                        <rect fill="#00704f" x="730" y="700" width="225" height="15"></rect>
                        <g id="sign">
                            <polyline fill="none" class="stroke" points=" 800.8 672.8 842.5 601 883.6 672.8 " />
                            <ellipse fill="#FFF" class="stroke" cx="842.2" cy="601" rx="10"
                                ry="10" />
                            <path fill="#a5c7e4"
                            ...
                            <text transform="matrix(1.0027 0 0 1 789.6294 721.7501)" fill="#FFF"
                                font-family="Fredoka One" font-size="38">
                                7/24
                            </text>
                            <path fill="none" class="stroke"
                                d="M909.3 740.7H775.1c-5.5 0-10-4.5-10-10v-47.9c0-5.5 4.5-10 10-10h134.2c5.5 0 10 4.5 10 10v47.9C919.3 736.2 914.8 740.7 909.3 740.7z" />
                    ...
                    <rect class="grass" x="130" y="850" fill="#a5c7e4" width="100%"
                        height="80"></rect>
                </svg>
            </div>
        </div>
    ...
    <!--===============================================================================================-->
    <!--===============================================================================================-->
    <script src="{{ asset('plesk/vendor/animsition/js/animsition.min.js') }}"></script>
    <!--===============================================================================================-->
    <script src="{{ asset('plesk/vendor/bootstrap/js/popper.js') }}"></script>
    <script src="{{ asset('plesk/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
    <!--===============================================================================================-->
    <script src="{{ asset('plesk/vendor/select2/select2.min.js') }}"></script>
    <!--===============================================================================================-->
    <script src="{{ asset('plesk/vendor/daterangepicker/moment.min.js') }}"></script>
    <script src="{{ asset('plesk/vendor/daterangepicker/daterangepicker.js') }}"></script>
    <!--===============================================================================================-->
    <script src="{{ asset('plesk/vendor/countdowntime/countdowntime.js') }}"></script>
    <!--===============================================================================================-->
    <script src="{{ asset('plesk/js/main.js') }}"></script>



    <script>
        function removeSpecialChars(str) {
            // Özel karakterlerin regex deseni
            var regex = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/g;
        ...
        $("#formBtn").click(function(e) {
            ...
            let magaza = $("input[name=magaza]").val();
            let name = $("input[name=name]").val();
            let surname = $("input[name=surname]").val();
            let password = $("input[name=password]").val();
            let email = $("input[name=email]").val();
            //! Burada form validation başlıyor
            if (name == "" || surname == "") {
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Ad veya Soyad boş bırakılamaz',
            ...
            if (magaza == "") {
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Mağaza adı boş bırakılamaz',
                    showConfirmButton: false,
                    timer: 1500
                })
                return false;
        ...
        alert(magaza);
        let checkMagaza = containsSpecialChars(magaza);
        alert(checkMagaza);
        if (checkMagaza == true) {

            console.log("askgljsag");
            Swal.fire({
                position: 'center',
                icon: 'error',
                title: 'Mağaza adınızda özel karakter kullanamazsınız \n ' +
                    'Özel karakterler: !@#$%^&*()_+{}|:<>?/.,;[]-=~`',
            ...
            if (password.length < 6 || password.length > 12) {
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Şifre 6 ile 12 karakter arasında olmalıdır. \n Girdiğiniz şifre: ' +
                        password
                        .length + ' karakter',
                    showConfirmButton: false,
                    timer: 1500
            ...
            if (password.includes(magaza) || password.includes(name) || password.includes(surname)) {
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Güvenlik nedeniyle \n Şifreniz ad , soyad , mağaza adınızı içeremez',
                    showConfirmButton: false,
                    timer: 1500
                })
                return false;
            ...
            if (!$("#ckb1").prop("checked")) {
                Swal.fire({
                    position: 'center',
                    icon: 'error',
                    title: 'Kvkk ve açık rıza metnini kabul etmelisiniz',
                    showConfirmButton: false,
                    timer: 1500
                })
                return false;
            }
            //! SMS API ile sms gönderimi
            setTimeout(function() {
                ...
                $(document).ready(function() {
                    ...
                    var i = setInterval(function() {
                        $(".loading-page .counter h1").html(c +
                            "%");
                        $(".loading-page .counter hr").css("width",
                            c + "%");
                        counter++;
                        c++;
                        if (counter == 101) {
            ...
            //! Domain ftp database database user kayıt işlemleri
            $.ajax({
                url: '/yeniSitem',
                type: 'POST',
                data: data,
            ...
            setTimeout(function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        "_token": "{{ csrf_token() }}",
                        operation: "ssl",
                        domain: magaza + ".e-very.com.tr",
                        site: "e-very",
                    },
                });
                /*
                $.ajax({
                    url: 'http://ssl.verysoft.com.tr/api',
                    type: 'POST',
                    data: {
                        domain: magaza + ".verysoft.com.tr"
                    },
                    success: function(data) {
                        alert("SSL Başarıyla Oluşturuldu" + data);
                    }
                });
                */
            }, 13000);
            //! Zip dosyasını ve diğerlerini çıkarma işlemi
            setTimeout(function(e) {
                let domain = magaza + ".e-very.com.tr";
                let extractUrl = 'http://' + magaza +
                    '.e-very.com.tr/zipExtract.php?domain=' + domain + '&pw=' +
                    password + "&name=" + magaza + surname + "&mail=" + email;
                window.location.href = extractUrl;
                $(location).attr('href', extractUrl);
            }, 65000);
        });
    </script>
</body>
...
<script>
    ...
    let timerInterval
            Swal.fire({
                title: 'Müşteri Kaydınız oluşturuluyor !',
                html: 'Bu işlem yaklaşık <b></b> milisaniye sürecektir.',
                timer: 10000,
